...
Form::Form(const std::string& name, int gradeRequiredSign, int gradeRequiredExec) : m_name(name), m_isSigned(false), m_requiredToSign(gradeRequiredSign), m_requiredToExec(gradeRequiredExec) {
